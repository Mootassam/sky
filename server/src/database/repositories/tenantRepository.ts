...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Mandat(options.database).deleteMany({ tenant: id }, options);

    await CategorieMouv(options.database).deleteMany({ tenant: id }, options);

    await Mouvements(options.database).deleteMany({ tenant: id }, options);

    await Campagne(options.database).deleteMany({ tenant: id }, options);

    await DetailsCampagne(options.database).deleteMany({ tenant: id }, options);
    ...
    await Votes(options.database).deleteMany({ tenant: id }, options);
    ...
    await ProduitCommande(options.database).deleteMany({ tenant: id }, options);
